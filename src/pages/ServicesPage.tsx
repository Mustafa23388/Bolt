    ...
    >
      <div className={`grid md:grid-cols-2 gap-12 items-center ${!isEvenIndex && 'md:grid-flow-dense'}`}>
        <div>
          ...
          <p className="text-lg text-blue-100/80 mb-8 leading-relaxed">{service.fullDesc}</p>
          ...
          <button className="group px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 text-white rounded-lg font-semibold hover:shadow-lg hover:shadow-blue-500/50 transition-all duration-300 hover:scale-105 flex items-center gap-2">
            Learn More
